...
public class X509Data {
    ...
    @XmlAnyElement
    protected List<java.lang.Object> x509DataContent;

    /**
     * Gets the value of the x509DataContent property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the x509DataContent property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getX509DataContent().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<java.lang.Object> getX509DataContent() {
        if (x509DataContent == null) {
            x509DataContent = new ArrayList<java.lang.Object>();
        }
        return this.x509DataContent;
    }

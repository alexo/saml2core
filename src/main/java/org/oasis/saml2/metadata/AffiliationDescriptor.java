...
@XmlRootElement(name = "AffiliationDescriptor")
public class AffiliationDescriptor {
    ...
    protected List<String> affiliateMembers;
    ...
    /**
     * Gets the value of the affiliateMembers property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the affiliateMembers property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAffiliateMembers().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getAffiliateMembers() {
        if (affiliateMembers == null) {
            affiliateMembers = new ArrayList<String>();
        }

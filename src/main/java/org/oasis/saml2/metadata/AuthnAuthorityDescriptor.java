    ...
    extends RoleDescriptorType
{
    ...
    /**
     * Gets the value of the authnQueryServices property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the authnQueryServices property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAuthnQueryServices().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<EndpointType> getAuthnQueryServices() {
        if (authnQueryServices == null) {
            authnQueryServices = new ArrayList<EndpointType>();
        }
